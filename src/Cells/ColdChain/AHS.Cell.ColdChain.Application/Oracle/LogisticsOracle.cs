// src/Cells/ColdChain/AHS.Cell.ColdChain.Application/Oracle/LogisticsOracle.cs
using System;
...
public sealed class LogisticsOracle
{
    ...
    /// </summary>
    public ValueTask<OracleResult> CalculateAsync(OracleRequest req, CancellationToken ct)
    {
